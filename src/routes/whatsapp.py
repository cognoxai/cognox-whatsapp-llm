...
from src.whatsapp_api import whatsapp_api # A importação continua a mesma
...
def handle_webhook():
    ...
    try:
        if (data.get("object") == "whatsapp_business_account" and
            ...
            # Passamos o número de mensagens no histórico para a IA saber se é a primeira interação.
            ...
            # --- CHAMADA DA NOVA FUNÇÃO HUMANIZADA ---
